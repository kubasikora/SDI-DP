...
\input{tex/1-cel-pracy-zastosowania.tex}
\input{tex/2-przeglad-rozwiazan.tex}
\input{tex/3-rozwiazanie-problemu.tex}
% \input{tex/4-wyniki-badan.tex}
% \input{tex/5-podsumowanie-wnioski.tex}
% %% dodatkowe
% \input{tex/6-dodatkowe-slajdy.tex}
